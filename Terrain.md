...
After having the 3D Stylized Animated Dogs Kit installed and imported, you can proceed to go directly to the Models or Prefabs folder and pick the dog breeds you want to place around the scene. In this case, the default poses were not an issue.
